...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post attachments_url, params: { attachment: { extension: @attachment.extension, nombre: @attachment.nombre, post_id: @attachment.post_id } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { extension: @attachment.extension, nombre: @attachment.nombre, post_id: @attachment.post_id } }
